...
MLFLOW_TRACKING_URI = "https://dagshub.com/harsh392/Capstone-project.mlflow"
dagshub.init(repo_owner="harsh", repo_name="Capstone-project3", mlflow=True)
...
# Set MLflow Tracking URI & DAGsHub integration
MLFLOW_TRACKING_URI = "https://dagshub.com/harsh/YT-Capstone-Project.mlflow"
dagshub.init(repo_owner="harsh", repo_name="Capstone-Project2", mlflow=True)
mlflow.set_tracking_uri(MLFLOW_TRACKING_URI)
mlflow.set_experiment("LoR Hyperparameter Tuning")
